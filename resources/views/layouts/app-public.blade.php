...
<html lang="{{str_replace('_', '-', app()->getLocale())}}">
    <head>
        ...
        <meta name="description" content="Come and play music!">
        <meta name="keywords" content="ecommerce, instruments">
        <meta name="author" content="422023018 - Billy Michael Junus">

        <title>@yield('title') | 422023018 - Billy Michael Junus</title>
