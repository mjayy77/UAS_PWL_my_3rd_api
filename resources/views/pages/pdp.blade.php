...
<div class="site-wrapper-reveal">
    <div class="single-product-wrap section-space--pt_90 border-bottom pb-5 mb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-6-sm-12 col-xs-12">
                    ...
                    <div class="product-details-left">
                        <div class="product-details-images-2 slider-lg-image-2">
                            ...
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product/single-product-02.webp')}}" class="poppu-img product-img-main-href">
                            ...
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product/single-product-03.webp')}}" class="poppu-img poppu-img product-img-main-href">
                                        <img src="{{asset('assets/images/product/single-product-03.webp')}}" class="img-fluid img-fluid product-img-main-src" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="easyzoom-style">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="{{asset('assets/images/product/single-product-04.webp')}}" class="poppu-img poppu-img product-img-main-href">
                                        <img src="{{asset('assets/images/product/single-product-04.webp')}}" class="img-fluid img-fluid product-img-main-src" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="product-details-thumbs-2 slider-thumbs-2">
                            ...
                            <div class="sm-image">
                                <img src="{{ asset('assets/images/product/small/3-100x100.webp') }}" alt="product image thumb" class="product-img-main-src">
                            </div>
                            <div class="sm-image">
                                <img src="{{ asset('assets/images/product/small/4-100x100.webp') }}" alt="product image thumb" class="product-img-main-src">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-details-content">
                        ...
                        <div class="quickview-action-wrap mt-30">
                            <div class="quickview-cart-box">
                                ...
                                <div class="text-color-primary product-add-to-cart-is-disabled" style="display:none;font-size:10px">
                                    You may not be able to buy this item now, but keep it on your wishlist so we can remind you when it is back in stock
                                </div>
                                <div class="quickview-button">
                                    <div class="quickview-cart button product-add-to-cart">
                                        <button type="button" class="btn--lg btn--black font-weight--regular text-white">
                                            Add to cart
                                        </button>
                                    </div>
                        ...
                        <div class="product_meta mt-30">
                            <div class="posted_in item_meta">
                                ...
                                <span id="product-company" class="text-color-primary"></span>
                            </div>
                            <div class="posted_in item_meta">
                                <span class="label">Produced: </span>
                                <span id="product-produced"></span>
                            </div>
